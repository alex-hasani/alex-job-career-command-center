...
$task = New-ScheduledTask -Action $action -Trigger $trigger -Settings $settings -Principal $principal -Description 'Creates a verified, dated ZIP of the complete Job Search project every midnight.'
