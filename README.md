...
See [PUBLIC_MIRROR_GUARDRAILS.md](PUBLIC_MIRROR_GUARDRAILS.md) for the canonical-repository boundary, safe mirror allowlist, and installed audit-hook workflow.
